...
var Modal = function () {
	...
	_createClass(Modal, [{
		...
		key: "keyPressHandler",
		value: function keyPressHandler(k) {
			if (k.keyCode == 27) {
				this.closeModal();
			}
		}
...
var _openModal = __webpack_require__(3);
...
var modal = new _openModal2.default();

new _revealOnScroll2.default((0, _jquery2.default)(".feature-item"), "90%");
new _revealOnScroll2.default((0, _jquery2.default)(".testimonial"), "90%");
